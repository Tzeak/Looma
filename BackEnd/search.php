...
if(isset($_GET["search"]) && $_GET["search"] != '')
{
	...
	$search_query = array('dn' => new MongoRegex("^$searchword/i"));
	$result = queryMongo($search_query);
	echo json_encode($result);
} 
 
// FOR FULL TEXT SEARCH, CHECK OUT MONGO'S runCommand THINGY???
// FIND MORE OPTIONS FOR SEARCH ALGORITHMS
